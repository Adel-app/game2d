...
export class Running extends State {
    ...
    handleInput(input) {
        this.game.particles.unshift(new Dust(this.game, this.game.player.x + this.game.player.width / 2,
...
export class Jumping extends State {
    ...
    enter() {
        ...
        this.game.player.playSound("soundJump");
...
export class Rolling extends State {
    ...
    handleInput(input) {
        this.game.particles.unshift(new Fire(this.game, this.game.player.x + this.game.player.width / 2,
...
export class Diving extends State {
    ...
    handleInput(input) {
        ...
        if (this.game.player.onGround()) {
            this.game.player.setState(states.RUNNING, 1);
            this.game.player.playSound("soundSplash");
            for (let i = 0; i < 30; i++) {
